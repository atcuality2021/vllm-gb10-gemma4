...
echo ""
echo "  (Optional) add ManthanQuant 3-bit KV cache compression:"
echo "    ./patches/manthanquant-kv-compression.sh \"$VENV_DIR\""
echo ""
echo "  Launch the MoE Gemma 4 with MTP speculative decoding"
echo "  (prefix MANTHANQUANT=1 to also enable KV compression):"
